 ...
 * @author morteza
 */
public class DozPanel extends javax.swing.JPanel {
     ...
     * @param user
     */
    public DozPanel(UserModel user) {
        initComponents();
        this.user = user;
        initDozInfo();
    }
    
    private void initDozInfo() {
        gh20.setText(user.ghors_20);
        gh40.setText(user.ghors_40);
        gh5.setText(user.ghors_5);
        b2.setText(user.bupre_2);
        b4.setText(user.bupre_4);
        b8.setText(user.bupre_8);
        bBN.setText(user.bupre_bn);
        metadon.setText(user.metadon);
        opiom.setText(user.opiom);
        dayCount.setText(user.day);
    }
